...
export default function Home() {
  ...
  return (
    <main className={darkMode ? "dark-theme" : ""}>
      ...
      <section className="about section-grid" id="sobre"><div className="section-label"><span>01</span><span>Perfil</span></div><div className="section-content"><p className="section-kicker">Um cuidado que começa na escuta</p><h2>Enfermagem é técnica.<br /><em>Também é presença.</em></h2><p className="body-copy">Enfermeira graduada pelo Centro Universitário Aparício Carvalho (FIMCA), com sólida formação prática em Atenção Primária, Urgência/Emergência e Maternidade.</p><p className="body-copy">Pós-graduanda em Auditoria em Serviços de Saúde com previsão de termino em fevereiro de 2027 e em Urgência/Emergência com ênfase em UTI com previsão de termino em maio de 2027. Minha atuação é guiada pela assistência humanizada, pela segurança do paciente e pela prática baseada em evidências científicas.</p><a className="text-link" href="https://lattes.cnpq.br/5506554419322085" target="_blank" rel="noreferrer">Ver Currículo Lattes <span>↗</span></a></div><div className="about-aside"><span className="aside-number">02</span><p>Especialização<br />em andamento</p><span className="aside-line" /></div></section>
